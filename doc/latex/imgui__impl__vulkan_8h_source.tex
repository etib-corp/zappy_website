...
\hypertarget{imgui__impl__vulkan_8h_source}{}\label{imgui__impl__vulkan_8h_source}\index{gui/ege/imgui/backends/imgui\_impl\_vulkan.h@{gui/ege/imgui/backends/imgui\_impl\_vulkan.h}}
...
\DoxyCodeLine{00059\ \textcolor{preprocessor}{\#include\ <Volk/volk.h>}}
...
\DoxyCodeLine{00072\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structImGui__ImplVulkan__InitInfo}{ImGui\_ImplVulkan\_InitInfo}}}
\DoxyCodeLine{00073\ \{}
...
\DoxyCodeLine{00103\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{bool}\ \ \ \ \ \ \ \ \ ImGui\_ImplVulkan\_Init(\mbox{\hyperlink{structImGui__ImplVulkan__InitInfo}{ImGui\_ImplVulkan\_InitInfo}}*\ info);}
...
\DoxyCodeLine{00106\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ ImGui\_ImplVulkan\_RenderDrawData(\mbox{\hyperlink{structImDrawData}{ImDrawData}}*\ draw\_data,\ VkCommandBuffer\ command\_buffer,\ VkPipeline\ pipeline\ =\ VK\_NULL\_HANDLE);}
...
\DoxyCodeLine{00136\ }
\DoxyCodeLine{00137\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structImGui__ImplVulkanH__Frame}{ImGui\_ImplVulkanH\_Frame}};}
\DoxyCodeLine{00138\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}};}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00142\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkanH\_DestroyWindow(VkInstance\ instance,\ VkDevice\ device,\ \mbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}}*\ wd,\ \textcolor{keyword}{const}\ VkAllocationCallbacks*\ allocator);}
...
\DoxyCodeLine{00150\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structImGui__ImplVulkanH__Frame}{ImGui\_ImplVulkanH\_Frame}}}
\DoxyCodeLine{00151\ \{}
...
\DoxyCodeLine{00158\ \};}
\DoxyCodeLine{00159\ }
\DoxyCodeLine{00160\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structImGui__ImplVulkanH__FrameSemaphores}{ImGui\_ImplVulkanH\_FrameSemaphores}}}
\DoxyCodeLine{00161\ \{}
...
\DoxyCodeLine{00168\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}}}
\DoxyCodeLine{00169\ \{}
...
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \ \ \ \ \mbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}}()}
\DoxyCodeLine{00188\ \ \ \ \ \{}
