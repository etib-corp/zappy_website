...
const Bloc: React.FC<{ properties: any }> = ({ properties }) => {
  return (
    <Card className="max-w-sm blur transition transform hover:-translate-y-1 hover:blur-none motion-reduce:transition-none motion-reduce:hover:transform-none"
