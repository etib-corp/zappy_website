...
{\bfseries{Once Dear Im\+Gui is setup and running, run and refer to {\ttfamily Im\+Gui\+::\+Show\+Demo\+Window()} in imgui\+\_\+demo.\+cpp for usage of the end-\/user API.}}\hypertarget{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md1}{}\doxysubsubsection{\texorpdfstring{What are backends?}{What are backends?}}\label{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md2}{}\doxysubsubsection{\texorpdfstring{Integrating a backend}{Integrating a backend}}\label{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md2}
See \"{}\+Getting Started\"{} section of \href{https://github.com/ocornut/imgui/blob/master/docs/EXAMPLES.md}{\texttt{ EXAMPLES.\+MD}} for more details.\hypertarget{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md3}{}\doxysubsubsection{\texorpdfstring{List of backends}{List of backends}}\label{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md3}
...
\end{DoxyVerb}
 Emscripten is also supported! The SDL+\+GL, GLFW+\+GL and GLFW+\+Web\+GPU examples are all ready to build and run with Emscripten.\hypertarget{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md4}{}\doxysubsubsection{\texorpdfstring{Backends for third-\/party frameworks, graphics API or other languages}{Backends for third-party frameworks, graphics API or other languages}}\label{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md4}
See \href{https://github.com/ocornut/imgui/wiki/Bindings}{\texttt{ https\+://github.\+com/ocornut/imgui/wiki/\+Bindings}} for the full list (e.\+g. Adventure Game Studio, Cinder, Cocos2d-\/x, Game Maker Studio2, Godot, LÖ\+VE+\+LUA, Magnum, Monogame, Ogre, open\+Frameworks, Open\+Scene\+Graph, SFML, Sokol, Unity, Unreal Engine and many others).\hypertarget{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md5}{}\doxysubsubsection{\texorpdfstring{Recommended Backends}{Recommended Backends}}\label{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md5}
...
\end{longtabu}
\hypertarget{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{Using a custom engine?}{Using a custom engine?}}\label{md_gui_2ege_2imgui_2docs_2BACKENDS_autotoc_md6}
